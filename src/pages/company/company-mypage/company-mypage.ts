...
export class CompanyMypagePage {
  ...
  levelClass: String = 'Company';
  nickname: String = '더콰이엇';
  proceedingProjectNum = 2;
  endProjectNum = 3;
  segmentProjectCondition: String = '';
  ...
  endProjects = [
    {
      project_id: 1,
      project_main_image: 'assets/img/project-main-image1.png',
      project_end_date: '2017-09-10 00:00:00',
      participant_num: 20,
      max_participant_num: 30,
      project_name: '프로젝트 이름',
      project_summary: '프로젝트 설명 프로젝트 설명 프로젝트 설명 프로젝트 설명 프로젝트 설명 프로젝트 설명 프로젝트 설명',
    ...
    },
    {
      project_id: 2,
      project_main_image: 'assets/img/project-main-image2.png',
      project_end_date: '2017-09-12 00:00:00',
      participant_num: 30,
      max_participant_num: 30,
      project_name: '프로젝트 이름2',
      project_summary: '프로젝트 설명2 프로젝트 설명2 프로젝트 설명2 프로젝트 설명2 프로젝트 설명2 프로젝트 설명2 프로젝트 설명2',
    ...
    },
    {
      ...
      project_end_date: '2017-09-16 00:00:00',
      participant_num: 30,
      max_participant_num: 30,
      project_name: '프로젝트 이름3',
      project_summary: '프로젝트 설명3 프로젝트 설명3 프로젝트 설명3 프로젝트 설명3 프로젝트 설명3 프로젝트 설명3 프로젝트 설명3',
      avatar_image: 'assets/img/company-avatar-image3.png',
      nickname: '닉네임3',
    }
  ...
  ionViewDidLoad() {
    ...
    // this.httpService.getCompanyInfo()
    // .finally(() => {
    //   loading.dismiss();
    // })
    // .subscribe(
