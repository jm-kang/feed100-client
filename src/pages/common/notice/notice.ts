...
export class NoticePage {
  ...
  constructor(private themeableBrowser: ThemeableBrowser, public viewCtrl: ViewController, public navCtrl: NavController, public ModalWrapperPage: ModalWrapperPage, public statusBar: StatusBar) {
  }
  ...
  ionViewDidLoad() {
    ...
    cordova.ThemeableBrowser.open('https://m.blog.naver.com/PostList.nhn?blogId=feed100_help&from=postList&categoryNo=24', '_blank', {
      statusbar: {
        color: '#000000'
      },
      hiddden: 'yes',
