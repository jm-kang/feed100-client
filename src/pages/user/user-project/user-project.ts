    ...
    .subscribe(
      (data) => {
        if(data.success == true) {
          this.rewardProjects = data.data.rewardProjects;
          this.participatingProjects = data.data.participatingProjects;
          this.recommendedProjects = data.data.recommendedProjects;
