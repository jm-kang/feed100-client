...
export class UserHelpPage {
  ...
  userHelpPart2 = [
    ...
    },
    {
      ...
      content2: "스토리를 모두 이해하셨으면 <strong>스토리 퀴즈를 풀고</strong> 다음 단계인 <strong>피드백을 작성</strong>해 주세요!",
      bottomImg2: "",
      icon: "ios-add-circle-outline",
      showDetails: false,
    },
  ...
  userHelpPart4 = [
    ...
    {
      title: "포인트 환전 신청은 어떻게 하나요?",
      subTitle: "상단 설정 버튼을 누르시고 포인트 환전 신청을 하세요!",
      topImg: "",
      content: "이용약관 '제21 조 보상기준' 에 따릅니다.<br><br>금액 선택 > 예금주 입력 > 입금 은행 입력 > 계좌번호 입력 > 신청하기<br><br>금액은 <strong>최소 1만 포인트부터 최대 10만 포인트까지</strong> 신청 가능합니다.<br><br>환전 금액은 신청 마감일(매월 15일, 월 1회) 기준 5영업일 내에 입력한 은행으로 입금함으로써 적법 하게 지급한 것으로 봅니다.<br><br>즉, 월 14일까지의 신청자는 그 달에, 14일 이후 신청자는 익월에 지급됩니다.",
