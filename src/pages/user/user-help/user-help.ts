...
export class UserHelpPage {
  ...
  userHelpPart3 = [
    ...
    },
    {
      ...
      content: "지난 인터뷰에서는 어떻게 답변을 했는지 잘 기억이 나지 않으세요?<br>그럴 때는 질문 하단에 있는 ‘지난 인터뷰 보기’ 버튼을 눌러보세요!<br><br>대화형식으로 질문과 답변을 쉽게 확인하실 수 있습니다!<br>또한, 기업이 찜하기를 누른 응답은 하트가 표시됩니다.<br>우수 참여자가 되어 더 많은 보상을 노려보세요!",
      bottomImg: "",
      content2: "",
      bottomImg2: "",
      icon: "ios-add-circle-outline",
