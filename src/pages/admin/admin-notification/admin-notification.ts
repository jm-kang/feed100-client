...
export class AdminNotificationPage {
  ...
  accessAlarmItem(link, project_id, alarm_id) {
    switch(link) {
      case "endProject":
        this.openAdminProjectReportPage(project_id);
        break;
      case "newUser":
      case "newInterview":
        this.openAdminProjectInterviewDetailPage(project_id);
        break;
    }
  }
  ...
  openAdminProjectInterviewDetailPage(project_id) {
    this.navCtrl.push('AdminProjectInterviewDetailPage', { "project_id" : project_id });
  }
