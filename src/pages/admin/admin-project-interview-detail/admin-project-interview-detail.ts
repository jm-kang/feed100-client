      ...
      buttons: [
        {
          ...
          handler: () => {
            this.commonService.showConfirmAlert('해당 사용자를 프로젝트에서<br>선정하시겠습니까?', 
            () => {
              this.commonService.isLoadingActive = true;
              let loading = this.commonService.presentLoading();
              ...
              .subscribe(
                (data) => {
                  if(data.success == true) {
                    this.back();
                    this.commonService.showBasicAlert('해당 사용자가 프로젝트에서 선정되었습니다.');
                  }
                  else if(data.success == false) {
                    this.commonService.apiRequestErrorHandler(data, this.navCtrl)
                    .then(() => {
            ...
            let alert = this.alertCtrl.create({
              ...
              buttons: [
                ...
                },
                {
                  text: '보내기',
                  handler: data => {
                    this.commonService.showConfirmAlert('해당 사용자에게 푸쉬를 보내시겠습니까?', 
                    () => {
                      this.commonService.isLoadingActive = true;
                      let loading = this.commonService.presentLoading();
                      ...
                      .subscribe(
                        (data) => {
                          if(data.success == true) {
                            this.back();
                            this.commonService.showBasicAlert('성공적으로 푸쉬되었습니다.');
                          }
                          else if(data.success == false) {
                            this.commonService.apiRequestErrorHandler(data, this.navCtrl)
                            .then(() => {
